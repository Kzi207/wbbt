...
module.exports.onLoad = () => {
  ...
  Promise.all(__2048.map($ => loadImage(`https://raw.githubusercontent.com/KhoaDo472005/2048/main/no${$}.png`)))
    .then(imgs => imgs.map(($, i) => all_ô[__2048[i]] = $))
    .catch(err => console.warn('[2048.js] Không thể pre-load ảnh tiles (sẽ thử lại khi chơi):', err?.message || err));
}
